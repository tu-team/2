...
/**
 * Stores SemanticNetwork links parameters.
 * @author max talanov
 *         date 2012-05-02
 *         time: 10:40 PM
 */

case class SemanticNetworkLink(_source: SemanticNetworkNode[Resource], _destination: SemanticNetworkNode[Resource], _uri: KnowledgeURI, _probability: Probability)
