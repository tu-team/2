...
KMOT Knowledge Modelling (schematic, icon-based), facilitates in system domain KB thought organization and communication knowledge that use between humans about the particular knowledge as the graphic representation, model, evolves. As will be seen, it can also be used both at a specialized domain knowledge level and at a meta-knowledge level, such as TSS virtual cognitive skills and competencies. Finally, the graphical KMOT as an executable program exports TU system resolution knowledge models for action processing.