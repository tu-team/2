...
1. **Sleep**
   2. Strongest synapses shrink
   2. Weekest disappear

###Glutamate

1. Regulates how one learns
1. **Long term potentiation**
1. Strengthening the synapses
1. **Formation of long term memories**
1. **Alertness**
1. **Memory**
1. Reward
1. Incentive to retain new information
1. **Forgetting**
...
1. **Stress**
1. Interfere with hippocampal functions
1. Stops brain from retrieving information effectively

###Oxytocin

1. Feel good hormone
1. Social communication hormone
1. Protection from stress hormones
1. Stimulation of neurogenesis
1. Affect emotions and thinking, but do not influence brain directly

The more motivated and interested one is in new information more dopamine is released and better one remembers.

###Dopamine

1. Pleasure
1. Increases level of acetylcholine(neurotransmitter)
...
Switching from one task to another reduces productivity by 40 percent.
...
1. Categorizes visual data
1. Routes to other parts of the brain for identification and storage
  2. Sensing motion
  2. Differentiating colors
  2. Spatial processing
1. **Imagination**
1. Short and long term memories
1. Context understanding

1. Child imagination is more real rather than adult

###Parietal lobes

1. Information of sense and touch
1. Numbers and math
1. Dyscalculia
1. Object manipulation
1. Visual spatial processing
1. Navigation of body
1. Senses
1. Reading maps and street directions
...
1. **Long term memory**
   2. Recognize things from memory
   2. Remembering alphabet

###Supplementary motor area

1. Helper of left and right hemisphere to work together
1. Posture
1. Planning complex body movies

###Eye fields

1. "Fast brain"
1. Control eye movement
