...
As emotional neuromodulation is connected to reward system \cite{neuromodulatory, emotionsbraintorobot, primer, appraisal_considered_as_a_process, computationalmodelsemotion, dont_worry_be_happy} first of all we supposed that most appropriate would be the implementation of this affective computation model as realistic neural network (like NEST \cite{nest}), put in life threatening situation. Classical example is zapping rat (brain) \cite{rats_memory}. ...
