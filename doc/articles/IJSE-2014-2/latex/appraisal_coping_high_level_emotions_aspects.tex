...
\title{Appraisal and coping aspects of computational emotional thinking.}
\shorttitle{Computational emotinal appraisal and coping.}
...
\bibliography{ref}
\input{appraisal_coping_high_level_emotions_aspects_appendix}
\end{document}
